...
### The All-in-One Manager for Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, OpenClaw & Hermes Agent
...
Modern AI-powered coding relies on tools like Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, OpenClaw, and Hermes — but each has its own configuration format. Switching API providers means manually editing JSON, TOML, or `.env` files, and there is no unified way to manage MCP and Skills across multiple tools.
...
- **One App, Nine Tools** — Manage Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, OpenClaw, and Hermes from a single interface
- **No More Manual Editing** — 50+ provider presets including AWS Bedrock, NVIDIA NIM, and community relays; just pick and switch
- **Unified MCP & Skills Management** — One panel to manage MCP servers and Skills across Claude, Codex, Gemini, Grok Build, OpenCode, VS Code Copilot, and Hermes with bidirectional sync
...
- **9 supported tools, 50+ presets** — Claude Code, Claude Desktop, Codex, Gemini CLI, Grok Build, OpenCode, VS Code Copilot, OpenClaw, Hermes; copy your key and import with one click
...
- **Unified MCP panel** — Manage MCP servers across Claude, Codex, Gemini, Grok Build, OpenCode, VS Code Copilot, and Hermes with bidirectional sync and Deep Link import
...
CC Switch supports nine tools: **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **Grok Build**, **OpenCode**, **VS Code Copilot**, **OpenClaw**, and **Hermes**. Each tool has dedicated provider presets and configuration management. Note: **VS Code Copilot** refers to the Copilot chat built into VS Code (Stable and Insiders), managed through its BYOK custom endpoint settings — not the standalone GitHub Copilot CLI or the GitHub Copilot app.
